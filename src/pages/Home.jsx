...
const resumeUrl = `${import.meta.env.BASE_URL}assets/Rajesh-Hugar-Resume.pdf`;
const projectOverviewFallback = `${import.meta.env.BASE_URL}assets/overview.png`;
            ...
            {projects.slice(0, 6).map((project) => (
              <Link key={project.id} to={`/projects/${project.id}`} className="group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl dark:border-white/10 dark:bg-slate-950">
                <div className="relative h-52 overflow-hidden">
                  <img src={project.heroImage} alt={project.title} className="h-full w-full object-cover transition duration-500 group-hover:scale-105" onError={(event) => { event.currentTarget.src = projectOverviewFallback; }} />
      ...
      <section id="resume" className="bg-slate-50 py-14 dark:bg-slate-900">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-start gap-6 rounded-2xl border border-teal-200 bg-white p-7 shadow-sm dark:border-teal-400/20 dark:bg-slate-950 sm:flex-row sm:items-center">
            ...
            <a href={resumeUrl} download className="inline-flex items-center gap-2 rounded-lg bg-teal-600 px-6 py-3 font-bold text-white transition hover:bg-teal-700">
